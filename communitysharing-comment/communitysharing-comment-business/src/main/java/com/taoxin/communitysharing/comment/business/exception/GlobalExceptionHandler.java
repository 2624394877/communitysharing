package com.taoxin.communitysharing.comment.business.exception;
...
//                        .append(fieldError.getField())
    ...
    public Response<Object> handleMaxUploadSizeExceededException(HttpServletRequest request, MaxUploadSizeExceededException e) {
        log.warn("响应: {}请求失败, 错误码: {}, 错误信息: {}", request.getRequestURI(), ResponseStatusEnum.FILE_SIZE_ERROR.getErrorCode(), e.getMessage());
        return Response.fail(ResponseStatusEnum.FILE_SIZE_ERROR);
    }
