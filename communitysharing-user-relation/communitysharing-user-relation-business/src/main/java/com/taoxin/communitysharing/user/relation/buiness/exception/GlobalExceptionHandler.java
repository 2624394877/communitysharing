package com.taoxin.communitysharing.user.relation.buiness.exception;
...
//                        .append(fieldError.getField())
    ...
    public Response<Object> handleIllegalArgumentException(HttpServletRequest request, IllegalArgumentException illegalArgumentException) {
        log.warn("响应: {}请求失败, 错误码: {}, 错误信息: {}", request.getRequestURI(), ResponseStatusEnum.PARAMS_NOT_VALID.getErrorCode(), illegalArgumentException.getMessage());
        return Response.fail(ResponseStatusEnum.PARAMS_NOT_VALID.getErrorCode(), illegalArgumentException.getMessage());
    }
